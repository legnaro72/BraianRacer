...
class BrainUI {
  ...
  help() {
    return this.intro('SCEGLI LA TUA SFIDA.','Poi parti subito.')+
      ...
      <button class="mode-card multi" data-action="NAV" data-page="MULTIPLAYER"><div class="mode-top"><span class="feature-icon">${icons.people}</span><span class="pill">2–6 GIOCATORI</span></div><div class="mode-bottom"><div><h3>Multiplayer</h3><p>Invita gli amici: la festa continua in pista!</p></div><span class="circle-arrow">${icons.arrow}</span></div><div class="mode-track"></div></button></div></section>
